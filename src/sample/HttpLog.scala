...
object HttpLog {
  ...
  def main(args: Array[String]) {
    ...
    val customSchema = StructType(Array(
      ...
      StructField("queryStringType,", StringType, true),
      StructField("cookie", StringType, true),
      StructField("resulttype", StringType, true),
      StructField("requestid", StringType, true),
      StructField("hostheader", StringType, true),
      StructField("requestprotocol", StringType, true),
      StructField("requestbytes", LongType, true),
      StructField("timetaken", DoubleType, true),
      StructField("xforwardedfor", StringType, true),
      StructField("sslprotocol", StringType, true),
      StructField("sslcipher", StringType, true),
      StructField("responseresulttype", StringType, true),
      StructField("protocol_version", StringType, true),
      StructField("fle_status StringType", StringType, true),
      StructField("fle_encrypted_fields", StringType, true)))
